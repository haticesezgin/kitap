    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-md-4">
                ...
                <p>Fırat üniversitesi yazılım mühendisliği öğrencileri tarafından hazırlanmış bir Kitap tanıtım blog sitesidir.</p>
            </div>
            ...
            <div class="col-md-4">
                ...
                <div>
                    <h3 class="footer-heading mb-4">Bizimle İletişime Geçiniz</h3>
                    <p>
